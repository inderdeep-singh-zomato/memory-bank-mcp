...
- Fix linter errors
- Improve the project's type structure

## Known Issues

- Issues with test-tools.ts script execution
- Potential incompatibilities with the MCP API

## Next Steps

- Verify compatibility with the MCP API
- Add more type validation tests
- Document the implemented type improvements
